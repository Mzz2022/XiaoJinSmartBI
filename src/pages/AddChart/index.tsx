...
const AddChart: React.FC = () => {
  ...
  const resultPg = "Pg: 通过折线图的形式，展示了一周（从周一到周日）内某种统计量的变化趋势。图表布局合理，数据清晰，通过平滑的曲线展示了数据的起伏变化，特别是周末数据的高点，可能暗示了周末活动的特殊性或重要性。此外，通过提示框的设置，用户可以方便地获取到图表上任意位置的具体数据，增强了图表的实用性和用户体验。"
  const optionPg = {
